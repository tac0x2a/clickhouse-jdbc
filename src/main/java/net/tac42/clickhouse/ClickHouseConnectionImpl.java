...
import net.tac42.clickhouse.except.ClickHouseUnknownException;
...
import net.tac42.clickhouse.util.ClickHouseHttpClientBuilder;
import net.tac42.clickhouse.util.LogProxy;
