...
import net.tac42.clickhouse.ClickhouseJdbcUrlParser;
...
public class ClickHousePropertiesTest {
    ...
    /**
     * Method {@link net.tac42.clickhouse.ClickhouseJdbcUrlParser#parseUriQueryPart(URI, Properties)} returns instance
